...
def create_spk_pdf(google_provider, spk_data):
    ...
    approval_time = spk_data.get('Waktu Persetujuan') # Ambil waktu persetujuan

    initiator_name = get_nama_lengkap_by_email(google_provider, initiator_email)
    
    # Buat blok detail untuk approver (Branch Manager)
    ...
    template_context = {
        ...
        "approver_details_html": approver_details_html # Kirim blok HTML ke template
    }
